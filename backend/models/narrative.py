...
class Location(SQLModel, table=True):
    ...
    base_visual: Optional[str] = Field(default=None)
    base_auditory: Optional[str] = Field(default=None)
    base_olfactory: Optional[str] = Field(default=None)
    base_tactile: Optional[str] = Field(default=None)
    base_atmosphere: Optional[str] = Field(default=None)

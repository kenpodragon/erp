...
- [ ] **2.6 — Economy, Anti-Cheat & Discovery** *(Ref: `docs/recs/2.6_ECONOMY_ANTICHEAT.md`)*
    - [x] **Currency Conversion:** Implement Session Gold -> Essence/Resources. (Completed in 2.2/2.4)
    - [ ] **Anti-Cheat & Validation**
        - [ ] Verify server-side CPS rate limiting and anomaly flagging.
        - [ ] Verify server-side damage verification against permanent stats.
        - [ ] Implement secure session integrity checks for Story Mode completion.
    - [ ] **Social & Communication**
        - [ ] Implement a Global chat channel with server-side profanity filtering.
        - [ ] Ensure chat architecture supports future chapter-specific channels.
    - [ ] **The Akashic Records (WIKI/Discovery System)**
        - [ ] Build the Collection/Library view for discovered stats, skills, and enemies (Pokedex-style).
        - [ ] Implement blurred/locked state for undiscovered lore.
        - [ ] Add "Discovery Counters" (e.g., 12/99 skills unlocked) to the Hub.
        - [ ] **Random Spawns:** Define a process to capture random entity spawns and implement their logic (where and when they appear).
    - [ ] **Onboarding & UI Polish**
        - [ ] Implement "Welcome" splash screens and help modals for new players.
        - [ ] Apply "Magic Research 2" aesthetic polish across Hub and Story Mode.
        - [ ] Maintain "Cyberpunk Green Terminal" aesthetic for the Idle Training loop.
        - [ ] Add help icons to skills/stats linking to WIKI pages.
    - [ ] **Animation Toggle (Reduce Motion)** *(Ref: `2.6_ECONOMY_ANTICHEAT.md` §4.3)*
        - [ ] Add "Reduce Motion" toggle to Game Settings modal.
        - [ ] Hide/disable BottomAnimatedBanner + non-essential combat VFX when enabled.
        - [ ] Persist in `player.settings` JSONB + respect `prefers-reduced-motion` CSS.

...
- `/db`: SQL migrations, seeding scripts for lore/enemies. Any SQL changes must be created as .SQL files in this folder. They will be manually run on the server.
...
5. `@docs/TESTING.md`: How to test the system.
6. `@docs/TODO.md`: What is being built *now*.
7. `@docs/INIT_INFRA.md`: Environment setup.
8. `@../Books/BOOKS.md`: Narrative source mapping.
